<div id="category-edit-dialog" class="dialog">
    <div class="dialog__content">
        <div class="dialog__content__header">
            ...
            <span class="material-icons close-button" onclick="onDialogClose('category-edit-dialog')">close</span>
        </div>
        <form action="category_edit.php" method="post" class="dialog__content__body">
            ...
            <div class="dialog__content__body__actions">
                <button class="button button-danger" type="button" onclick="onDialogClose('category-edit-dialog')">Cancel</button>
